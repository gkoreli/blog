...
The [directed preflight](../../packages/blog/drafts/research/oss-radar-07/12-directed-answer-preflight.md) has now run through [subscription-backed Codex and Claude Code CLIs](../../packages/blog/drafts/research/oss-radar-07/20-subscription-cli-experiment.md). Both real answers passed record-preservation checks; the [source review](../../packages/blog/drafts/research/oss-radar-07/21-real-answer-source-review.md) found three material errors in Claude's answer. The previous browser blocker is historical. Article revision and live acceptance are in progress, including a product-focused ending and one consolidated glossary. The prompt record now contains seventeen messages; the old footprint stays frozen. The larger study and engineering continuation remain open.
