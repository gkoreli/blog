...
The two real subscription CLI answers and source review remain completed evidence. Earlier local response fixtures did not call OpenRouter or a model; see the [claim audit](../../packages/blog/drafts/research/oss-radar-07/23-openrouter-claim-audit.md). The current prompt page contains twenty exact messages. The frozen partial footprint measures earlier work and excludes the real runs and full rewrite.

Publication history: [first release](../../packages/blog/drafts/research/oss-radar-07/18-publication-verification.md), [footprint freeze](../../packages/blog/drafts/research/oss-radar-07/19-research-footprint.md), and [real-experiment revision](../../packages/blog/drafts/research/oss-radar-07/22-real-experiment-article-revision.md). Their source/prompt counts describe those releases only.

Execution: [TASK-0134](../tasks/TASK-0134-oss-radar-07-project-experiment-and-article.md). The larger citation-frequency study and distinct analytics engineering continuation remain open. Trellner research (TASK-0132), citation design (TASK-0106), and newsletter work retain their separate scopes. The author's explicit prompt-record request overrides the usual OSS Radar no-prompts exception only for this issue.

[September 12 title correction](../../packages/blog/drafts/research/oss-radar-07/33-series-title-correction.md) restores the series prefix omitted during the rewrite.
