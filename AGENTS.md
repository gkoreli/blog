...
The newsletter is implemented with D1, Resend, and Turnstile; it is not future infrastructure. The September 7 investigation found a production verifier-secret failure and gaps in browser reporting and subscription lifecycle handling. Repair and end-to-end validation remain open in [the reliability worklist](docs/folders/FLDR-0010-newsletter-reliability-and-bot-protection-worklist.md). The article draft is outside `posts/` and unpublished.
