...
- **Resume from evidence.** Before repeating an incident investigation, read its active task, dated handoff, and saved captures. The [September 7 reliability checkpoint](docs/handoffs/2026-09-07-reliability-checkpoint.md) covers newsletter recovery and D1 report cost. Treat its timestamps as historical observations, not a live account-health check.
