...
export function privacyPage() {
  ...
  <p>The text of this site is licensed CC BY 4.0: reuse it, quote it, train on it, and credit Goga Koreli with a link to the canonical URL.</p>
</article>`;
}
