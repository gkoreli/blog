...
The [partial research footprint](/oss-radar-07-ai-citations/prompts#research-footprint) measures **43,272,331 tokens across eight recovered sessions from the earlier investigation**. It excludes this rewrite, the later real CLI experiment, and other disclosed work. Its frozen manifest records integrity commitments to private logs; it is auditable by the author, not independently reconstructible by readers. Token volume is not evidence that the claims are correct.
