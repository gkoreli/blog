...
| Work | Task | State and acceptance |
|---|---|---|
| Atomic confirmation admission across signup and resend | TASK-0137 | Complete: local concurrency/rollback and distinct deployed/live receipts |
| Bounded provider calls and honest outcomes | TASK-0126 | Partial: sender/ledger implemented; general ingestion, acknowledgement and alerts unfinished |
| Confirmation, resubscription, and suppression | TASK-0129 | Complete: local lifecycle cases and one live cycle; provider-event connection remains TASK-0142 |
| Browser verification and request failures | TASK-0125 | Partial: form recovery/reporting repaired; build/time/correlation and shared logger delivery gaps remain |
| Initial protection decision | TASK-0127 | Complete: retain platform and Turnstile with shared limits; no comparative efficacy result claimed |
| Production signup acceptance | TASK-0124 | Complete: real challenge, provider acceptance, Gmail Spam receipt and activation |
| Engineering article and evidence ledger | TASK-0128 | In progress: updated draft remains unpublished, with nine shaping prompts and no frozen footprint |
| Connect provider bounce/complaint events | TASK-0142 | Open: inspect existing Resend endpoints, install the missing signing-secret binding privately, verify a signed event |
| Investigate confirmation placement in Gmail Spam | TASK-0145 | Open: inspect this message's authentication results and sender configuration before choosing a change |
| Historical impact and address recovery | TASK-0123 / TASK-0130 | Incomplete access: reuse saved captures; no historical address recovered |
...
| [16-bookkeeping-review.md](16-bookkeeping-review.md) | Break audit, corrected instructions, local verification and private workspace recovery |
