...
| Build the earlier Promptfoo-focused article | Complete; superseded by the full rewrite below | [Publication module](../../../posts/026-oss-radar-07-promptfoo.ts), [manuscript](../../oss-radar-07-promptfoo.md) |
| Check the first publication style, references, and render | Historical pass: 38 sources and 10 glossary terms; see rewrite acceptance for current counts | [Candidate review](11-publication-candidate-review.md), [source refresh](16-publication-source-check.md) |
...
- [Publication module](../../../posts/026-oss-radar-07-promptfoo.ts) and [Markdown manuscript](../../oss-radar-07-promptfoo.md): current article with one combined glossary/source table.
...
- [Generation manuscript review](29-generation-manuscript-review.md): study numbers, task populations, and code claims.
- [Evaluation manuscript review](30-evaluation-manuscript-review.md): code anchors, actual retention, licenses, and frozen accounting.
- [Credibility manuscript review](31-credibility-manuscript-review.md): source-selection claims, voice, and the tests for the closing bets.
- [Rewrite acceptance](32-ai-citations-rewrite-acceptance.md): final editorial decisions, discovery package, checks, and release.
