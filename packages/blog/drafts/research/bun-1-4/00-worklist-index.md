# Bun 1.4 OSS Radar worklist

- Backlog folder: `FLDR-0006`
- Release/code audit: `TASK-0090` → `01-release-code-audit.md`
- Product/ecosystem theory: `TASK-0091` → `02-product-ecosystem-theory.md`
- Adversarial adoption review: `TASK-0092` → `03-adversarial-adoption-review.md`
- Article synthesis and publication: `TASK-0093`
- Preamble animation design and verification: `TASK-0094` → `04-preamble-animation-design.md`
- Main-session local reproduction: `05-local-reproduction.md`
...
OSS Radar publication rule: no public raw-prompt page. The research-footprint script will use an empty prompt input and report `promptCount: 0`; the article preamble will link directly to the committed evidence directory and public footprint manifest.
