...
- The [installed comparison](../../research/oss-radar-07/repro/installed/README.md) used a response we wrote and served locally to Promptfoo 0.122.2. No OpenRouter service or model was called. The omission concerns Promptfoo's OpenRouter connector **summary**; the transport cache retained the structured citation fields.
