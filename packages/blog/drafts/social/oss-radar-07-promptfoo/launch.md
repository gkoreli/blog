...
- At **2026-09-11 16:50 UTC**, the canonical URL returned **HTTP 200** with the earlier H1, “Promptfoo: Can It Preserve the Evidence Behind an AI Answer?” The destination exists, but the new manuscript was **not yet live in that check**. Share this copy after the parent verifies the rewritten release; align the HN title with any final H1 change.
- Copy only: no media, account analysis, composer preview, social publication, or live social-card inspection occurred.
