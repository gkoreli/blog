-- Migration 0003: add bounced_at column for accurate inactive-row purge timing.
...
-- bounced_at fixes this: set on bounce, used as the aging timestamp for inactive-row cleanup.
